...
/**
 * 打开相机，在后台线程做常规的扫描；它绘制了一个结果view来帮助正确地显示条形码，在扫描的时候显示反馈信息，
 * 然后在扫描成功的时候覆盖扫描结果
 */
public final class CaptureActivity extends Activity implements Callback {
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (fromLiveScan) {
            ...
            intent.putExtra(CaptureActivity.DECODED_CONTENT_KEY, rawResult.getText());
            intent.putExtra(CaptureActivity.DECODED_BITMAP_KEY, barcode);
