...
public class SlidingActivityHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
        mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.slidingmenu_main_layout, null);
    }
    ...
    public void setBehindContentView2(View view, LayoutParams layoutParams) {
        mViewBehind = view;
